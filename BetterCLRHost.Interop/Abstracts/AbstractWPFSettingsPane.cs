...
{
    public abstract class AbstractWPFSettingsPane : DisposableBase, Interfaces.ISettingsPane
    {
        #region Enums
        [Flags]
        enum WS : uint
        ...
        {
            Category = "DefaultSettingsPanelCategory";
        }
        ...
        public abstract bool HasDefaults();
