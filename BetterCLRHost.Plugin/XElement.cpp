...
namespace BetterCLRHost {
    ...
    Int32 XElement::ElementCount()
    {
        return element->NumElements();
    }

    Int32 XElement::ElementCount(System::String^ name)
    {
    ...
    XElement^ XElement::GetElementById(Int32 elementId)
    {
        ::XElement* elementPtr = element->GetElementByID(elementId);
        return elementPtr ? gcnew XElement(elementPtr) : nullptr;
    }

    XElement^ XElement::GetElementByItem(System::String^ name, System::String^ itemName, System::String^ itemValue)
    {
    ...
    XElement^ XElement::InsertElement(Int32 position, System::String^ name)
    {
        ::XElement* elementPtr = element->InsertElement(position, ToWString(name).c_str());
        return elementPtr ? gcnew XElement(elementPtr) : nullptr;
    }

    XElement^ XElement::CopyElement(XElement^ elementToCopy, System::String^ newName)
    {
        ::XElement* elementPtr = element->CopyElement(elementToCopy->element, ToWString(newName).c_str());
        return elementPtr ? gcnew XElement(elementPtr) : nullptr;
    }
    ...
    System::String^ XElement::GetString(System::String^ name, System::String^ defaultValue)
    {
    ...
    Int32 XElement::GetInt(System::String^ name)
    {
        return GetInt(name, 0);
    }

    Int32 XElement::GetInt(System::String^ name, Int32 defaultValue)
    {
    ...
    Generic::List<Int32>^ XElement::GetIntList(System::String^ name)
    {
        List<int> list;
        element->GetIntList(ToWString(name).c_str(), list);
        auto returnList = gcnew Generic::List<Int32>();
        for( unsigned int i = 0; i < list.Num(); i++ )
        {
    ...
    Generic::List<Int32>^ XElement::GetColorList(System::String^ name)
    {
        List<int> list;
        element->GetIntList(ToWString(name).c_str(), list);
        auto returnList = gcnew Generic::List<Int32>();
    ...
    Generic::List<Int32>^ XElement::GetHexList(System::String^ name)
    {
        List<int> list;
        element->GetIntList(ToWString(name).c_str(), list);
        auto returnList = gcnew Generic::List<Int32>();
    ...
    void XElement::SetInt(System::String^ name, Int32 number)
    {
    ...
    void XElement::SetHex(System::String^ name, Int32 hex)
    {
        element->SetHex(ToWString(name).c_str(), hex);
    }

    void XElement::SetColor(System::String^ name, Int32 color)
    {
        SetHex(name, color);
    }
    ...
    void XElement::SetIntList(System::String^ name, Generic::List<Int32>^ list)
    {
        List<int> _list;
        for( int i = 0; i < list->Count; i++ )
        {
    ...
    void XElement::SetHexList(System::String^ name, Generic::List<Int32>^ list)
    {
        List<DWORD> _list;
        for( int i = 0; i < list->Count; i++ )
        {
    ...
    void XElement::SetColorList(System::String^ name, Generic::List<Int32>^ list)
    {
    ...
    void XElement::AddInt(System::String^ name, Int32 number)
    {
    ...
    void XElement::AddHex(System::String^ name, Int32 hex)
    {
        element->AddHex(ToWString(name).c_str(), hex);
    }

    void XElement::AddColor(System::String^ name, Int32 color)
    {
        AddHex(name, color);
    }
    ...
    void XElement::AddIntList(System::String^ name, Generic::List<Int32>^ list)
    {
        List<int> _list;
        for( int i = 0; i < list->Count; i++ )
        {
    ...
    void XElement::AddHexList(System::String^ name, Generic::List<Int32>^ list)
    {
        List<DWORD> _list;
        for( int i = 0; i < list->Count; i++ )
        {
    ...
    void XElement::AddColorList(System::String^ name, Generic::List<Int32>^ list)
    {
